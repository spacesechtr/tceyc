...
def newbt(client,callback_query):
    ...
    if txt=="about":
        callback_query.message.edit(text=f"`Bot`            : [platonic0x0](t.me/platonic0x0)\n`Creator :` [platonic0x0](t.me/platonic0x0)\n`Language:` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Give Feedback", url="t.me/platonic0x0")]]))
    elif txt=="src":
        callback_query.message.edit(text="Enjoy...:-D\nhttps://github.com/spacesechtr/tceyc", disable_web_page_preview=True)
...
def about(client, message):
    client.send_message(chat_id=message.chat.id, reply_to_message_id=message.message_id,
                        text=f"`Bot`            : [platonic0x0](t.me/platonic0x0)\n`Creator :` [platonic0x0](t.me/platonic0x0)\n`Language:` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Feedback", url="t.me/platonic0x0")]]))
